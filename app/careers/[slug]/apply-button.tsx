                          ...
                          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full rounded-lg border ${fieldErrors['attached_portfolio'] ? 'border-red-500' : 'border-ink/20'} bg-bone/30 px-3 py-2 text-sm file:mr-4 file:rounded-full file:border-0 file:bg-gold-600/10 file:px-4 file:py-1 file:text-xs file:font-semibold file:text-gold-600 hover:file:bg-gold-600/20 focus:outline-none focus:ring-2 focus:ring-gold-600`}
                              />
...
export function StickyApplyButton(props: Props) {
  ...
  return (
    <div
      className={`fixed bottom-0 left-0 right-0 z-40 border-t border-navy/10 bg-white p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] shadow-[0_-4px_12px_rgba(0,0,0,0.08)] lg:hidden transition-transform duration-300 ease-in-out ${
