    ...
    const { error } = await resend.emails.send({
      ...
      html: `
        ...
        <table style="border-collapse:collapse;width:100%">
          ...
          ${(body.residential_location || body.city || body.country) ? `<tr><td style="padding:8px;font-weight:bold;border-bottom:1px solid #eee">Location</td><td style="padding:8px;border-bottom:1px solid #eee">${body.residential_location || [body.city, body.state || body.province, body.country].filter(Boolean).join(', ')}</td></tr>` : ''}
